...
Read the [shared contract](../marinara-change-request/SHARED_CONTRACT.md), parent `AGENTS.md`, and the approved HLD/plan before editing. Read `packages/client/.instructions.md` before any client edit.
