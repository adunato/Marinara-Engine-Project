...
- Application commits: `5ff1fbcb`, `8da9b278`, Conversation picker fix `3dd20d49`, UI/configuration refinement `15f12f2b`, retrieval preview `33519ceb`, daily-memory-only preview correction `59f10e4c`, chronological/uncapped preview refinement `355a522c`, and editable-card scroll correction `5aea5ea2`, fast-forwarded into nested application `main`.
