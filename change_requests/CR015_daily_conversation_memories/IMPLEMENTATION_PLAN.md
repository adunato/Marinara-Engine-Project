...
- Application commits: `5ff1fbcb`, `8da9b278`, Conversation picker fix `3dd20d49`, UI/configuration refinement `15f12f2b`, and retrieval preview `33519ceb`, fast-forwarded into nested application `main`.
...
- Focused Playwright validation passed: 5 tests covering global Agent Settings visibility/configuration, adding and configuring the agent from Conversation settings, formation, embedding persistence, edited lifecycle data, ranked injection, the read-only current-retrieval preview, and the day-grouped Conversation editor including its compact layout, themed importance control, and animated regeneration state.
