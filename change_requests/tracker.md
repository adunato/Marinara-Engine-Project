...
| CR012 | standalone | Expanded Tracker Panel | Makes the desktop Tracker panel's expanded profile materially larger while keeping compact, standard, tracker behavior, and data unchanged. | CR011 | Branch `change/CR012-expanded-tracker-panel` opened from custom application `main`; HLD proposes an 840px expanded target and awaits approval. |
