...
| CR015 | standalone | Daily Conversation Memories | Adds a built-in agent and Conversation UI for day-scoped memories that complement summaries and can be used with or instead of current memory recall. | None | Branch: `change/CR015-daily-conversation-memories`. Formation, retrieval, ranking, and Conversation editor requirements captured; awaiting HLD approval. |
